  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFE899AE).withOpacity(0.4), width: 2),
        boxShadow: [
          BoxShadow(
            color: const Color(0xFFD85A7F).withOpacity(0.28),
            blurRadius: 24,
                  ...
                  Container(
                    decoration: BoxDecoration(
                      gradient: RadialGradient(
                        ...
                        colors: [
                          Colors.transparent,
                          const Color(0xFF5A0E23).withOpacity(0.2),
                          const Color(0xFF1E0A12).withOpacity(0.7),
                        ],
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color(0xFFFF4081).withOpacity(0.8)),
                              boxShadow: [
                                BoxShadow(
