...
if exist "tool_install_logo.dart" (
    echo - Logo ve uygulama ikonlari yerlestiriliyor...
    call dart run tool_install_logo.dart
)
...
echo.
echo ===================================================
echo [2/4] Flutter Debug APK derleniyor...
echo ===================================================
