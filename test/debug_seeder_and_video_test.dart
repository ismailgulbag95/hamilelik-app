...
void main() {
  ...
  group('Debug Seeder ve Time-lapse Video Motoru Testleri', () {
    ...
    testWidgets('4. DebugPanelBottomSheet arayüzü ve butonları doğru render eder', (WidgetTester tester) async {
      ...
      expect(find.text('Geliştirici & Test Paneli'), findsOneWidget);
      expect(find.text('40 Haftalık Test Verisi Doldur'), findsOneWidget);
      expect(find.text('Time-lapse Video Oluştur & Oynat'), findsOneWidget);
      expect(find.text('Tüm Veritabanını Sıfırla'), findsOneWidget);
    });
  });
}
